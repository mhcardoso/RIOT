...
/* this is the part the actually works 	
unsigned long ubr;
ubr = 16000000uL; 
ubr = ubr/baudrate;    */
    /* get the default UART for now -> TODO: enable for multiple devices */
    ...
    dev->ACTL1 |= USCI_ACTL1_SSEL_SMCLK_0;
    dev->ACTL0 = 0;
    dev->ASTAT = 0;
    /* configure baudrate */
    ...
    dev->AMCTL = 0x06; /* replace with the proper variable on the msp430_regs.h file */
