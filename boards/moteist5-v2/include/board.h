...
#define MSP430_INITIAL_CPU_SPEED    16000000uL
#ifndef F_CPU
 ...
 * @{
 */
#define LED0_PIN                    GPIO_PIN(4, 5)
#define LED1_PIN                    GPIO_PIN(4, 6)
#define LED2_PIN                    GPIO_PIN(4, 7)

#define LED_OUT_REG                 P4OUT
#define LED0_MASK                   (0x20)
#define LED1_MASK                   (0x40)
#define LED2_MASK                   (0x80)
...
#define CC2420_PARAM_SFD           GPIO_PIN(P1, 1)
#define CC2420_PARAM_VREFEN        GPIO_PIN(P9, 7)
#define CC2420_PARAM_RESET         GPIO_PIN(P9, 6)
/** @} */
